...
const packages = [
  ...
  },
  {
    ...
    features: ["15 speech credits", "Full AI analysis", "Progress tracking", "No expiry", "Save 33% vs Starter"],
    popular: true,
  ...
  },
  {
    ...
    features: ["35 speech credits", "Full AI analysis", "Progress tracking", "No expiry", "Save 43% vs Starter", "Priority support"],
    popular: false,
    color: "border-border",
  },
];
